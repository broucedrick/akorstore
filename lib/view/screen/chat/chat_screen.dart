...
class ChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if(isFirstTime) {
      Provider.of<ChatProvider>(context, listen: false).initChatList(seller.shop.id);
                ...
                child: Padding(
                  ...
                  child: Row(children: [
                    ...
                    InkWell(
                      ...
                      child: Icon(
                        Icons.send,
                        color: Provider.of<ChatProvider>(context).isSendButtonActive ? ColorResources.getPrimary(context) : Theme.of(context).hintColor,
