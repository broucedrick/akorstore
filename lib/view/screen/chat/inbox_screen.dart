      ...
      body: Column(children: [
        ...
        Stack(children: [
          ClipRRect(
            ...
            child: Image.asset(
              Images.toolbar_background, fit: BoxFit.fill, height: 50+MediaQuery.of(context).padding.top, width: double.infinity,
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(
                child: Provider.of<SellerProvider>(context).isSearching
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: titilliumRegular.copyWith(color: ColorResources.getGainsBoro(context)),
                  ),
                  style: titilliumSemiBold.copyWith(color: Colors.white, fontSize: Dimensions.FONT_SIZE_LARGE),
                  onChanged: (String query) {
                    Provider.of<SellerProvider>(context, listen: false).filterList(query);
                  },
                )
                    :Text(
                  Strings.inbox,
              ...
              IconButton(
                icon: Icon(
                  Provider.of<SellerProvider>(context).isSearching ? Icons.close : Icons.search,
                  size: Dimensions.ICON_SIZE_LARGE,
                  color: Colors.white,
                ),
                onPressed: () => Provider.of<SellerProvider>(context, listen: false).toggleSearch(),
              ),
            ]),
          ),
        ]),

        isGuestMode ? NotLoggedInWidget() : Expanded(
          child: Provider.of<SellerProvider>(context).sellerList != null ? Provider.of<SellerProvider>(context).sellerList.length != 0 ? ListView.builder(
            physics: BouncingScrollPhysics(),
            itemCount: Provider.of<SellerProvider>(context).sellerList.length,
              ...
              return Column(
                children: [
                  ListTile(
                    ...
                    title: Text(Provider.of<SellerProvider>(context).sellerList[index].fName+' '+Provider.of<SellerProvider>(context).sellerList[index].lName, style: titilliumSemiBold),
                    subtitle: Text('When will you start?', style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL)),
                    trailing: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Text('16:12:18', style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL)),
                      ...
                      Container(
                        ...
                        child: Text('3', style: titilliumSemiBold.copyWith(
                    ...
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => ChatScreen(
                      seller: Provider.of<SellerProvider>(context).sellerList[index],
                    ))),
                  ),
                  Divider(height: 2, color: ColorResources.getChatIcon(context)),
                ],
              );
            },
