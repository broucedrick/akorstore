        ...
        child: CustomScrollView(
          ...
          slivers: [
            ...
            SliverAppBar(
              ...
              title: Image.asset(Images.akorit_text, height: 35,),
              actions: [IconButton(
                onPressed: (){
            ...
            SliverToBoxAdapter(
              child: Padding(
                padding: EdgeInsets.only(top: Dimensions.PADDING_SIZE_LARGE, bottom: 50.0),
                child: BannersView(),
              ),
            ),

            SliverPersistentHeader(pinned: true, delegate: SliverDelegate(child: Padding(
                              ...
                              child: Material(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    prefixIcon: Icon(Icons.search, color: ColorResources.getPrimary(context), size: Dimensions.ICON_SIZE_SMALL),
