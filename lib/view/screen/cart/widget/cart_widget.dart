                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      //   ),
                      //   child: Text(
                      //     PriceConverter.percentageCalculation(context, cartModel.price.toString(), cartModel.discount.toString(), cartModel.discountType),
                  ...
                  !fromCheckout ? Row(
                    children: [
                      Padding(
                        ...
                        child: QuantityButton(isIncrement: false, index: index, quantity: cartModel.quantity),
                      ),
                      Text(cartModel.quantity.toString(), style: titilliumSemiBold),
                      Padding(
                        padding: EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_SMALL),
                        child: QuantityButton(isIncrement: true, index: index, quantity: cartModel.quantity),
                      ),
                    ],
                  ) : SizedBox.shrink(),
                ],
