...
class OrderScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if(isFirstTime) {
      Provider.of<OrderProvider>(context, listen: false).initOrderList();
                      ...
                      builder: (context, orderProvider, child) => Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(width: 10),
                            OrderTypeButton(text: "Livrée", index: 1, orderList: orderProvider.deliveredList),
                            SizedBox(width: 10),
                            OrderTypeButton(text: "Annulée", index: 2, orderList: orderProvider.canceledList),
                          ],
                        ),
                      ),
                    )
