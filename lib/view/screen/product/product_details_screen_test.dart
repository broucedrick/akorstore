...
import 'package:sixvalley_ui_kit/view/screen/product/widget/bottom_cart_view_test.dart';
        ...
        return Scaffold(
          appBar: AppBar(
            title: Row(children: [
              ...
              Text('Detail du produit', style: robotoRegular.copyWith(fontSize: 20, color: Theme.of(context).textTheme.bodyText1.color)),
            ]),
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Seller
                product.consumerId == 'seller' ? SellerView(sellerId: product.consumerId) : SizedBox.shrink(),
                ...
                Container(
                  ...
                  child: ProductSpecification(productSpecification: product.description ?? ''),
                ),
