...
import 'package:sixvalley_ui_kit/view/screen/product/product_details_screen_test.dart';
import 'package:provider/provider.dart';

class ProductWidget extends StatelessWidget {
  final Product productModelTest;
  ProductWidget({@required this.productModelTest});
    ...
    return InkWell(
      onTap: () {
        Navigator.push(context, PageRouteBuilder(
          ...
          pageBuilder: (context, anim1, anim2) => ProductDetails(product: productModelTest),
        ));
      },
      child: Container(
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
            ...
            Hero(
              ...
              child: Container(
                ...
                child: Image.asset(productModelTest.photo),
              ),
            ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Hero(
                    tag: 'name-${productModelTest.id}',
                    child: Text(productModelTest.nom ?? '', style: robotoRegular, maxLines: 2, overflow: TextOverflow.ellipsis),
                  ),
                  SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),

                  Row(children: [
                    Hero(
                      tag: 'price-${productModelTest.id}',
                      child: Text(
                        "${productModelTest.prixVente} FCFA",
