...
class FancyBottomNavBarState extends State<FancyBottomNavBar>
  ...
  IconData nextImage = Icons.circle;
  IconData activeImage = Icons.circle;
  ...
  void didChangeDependencies() {
    ...
    activeImage = widget.tabs[currentSelected].iconType;
  ...
  _setSelected(UniqueKey key) {
    ...
    if (mounted) {
      setState(() {
        ...
        nextImage = widget.tabs[selected].iconType;
      });
    }
  }
                            ...
                            child: Padding(
                              ...
                              child: AnimatedOpacity(
                                ...
                                child: Padding(
                                  ...
                                  child: Icon(activeImage, color: activeIconColor,),
                                ),
                              ),
                            ),
                          ),
...
class FancyTabData {
  FancyTabData({@required this.iconType, @required this.title, this.onclick});
